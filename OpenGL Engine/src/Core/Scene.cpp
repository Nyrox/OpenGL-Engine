...
Scene::Scene() : wireframeShader("shaders/editor/wireframe.vert", "shaders/editor/wireframe.frag"), wireframeMaterial(wireframeShader), sceneCollisionDebugModel(wireframeMaterial, std::make_shared<Mesh>(Mesh::generateCube({ 1, 1, 1 }))) {
